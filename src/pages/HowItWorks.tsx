...
const steps = [
  ...
  },
  {
    ...
    details: ['Production starts same day as approval', 'Premium garments and materials', 'Quality checked before packing', 'Standard: 5–7 business days', 'Rush: 48 hours available'],
  },
  {
    num: '05',
    icon: <Truck size={32} />,
