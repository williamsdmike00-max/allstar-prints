...
import { SocialLink, SOCIAL_LINKS } from '../social/SocialIcons'
    ...
    <footer className="bg-brand-dark2 border-t border-white/8">
      ...
      <div className="container-xl section-padding py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="lg:col-span-1">
          ...
          {/* Social icons — shared with the hero strip. Footer uses the
              dark-theme variant; idle press-pulse + dashed-ring spin echo
              the print-press feel. */}
          <div className="flex items-center gap-4 mt-6">
            {SOCIAL_LINKS.map(({ href, label, Icon, delay }) => (
              <SocialLink key={href} href={href} label={label} delay={delay} theme="dark">
                <Icon size={22} />
              </SocialLink>
            ))}
          </div>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3">
            ...
            <li className="flex items-start gap-2.5 text-sm text-brand-silver">
              ...
              <a href="mailto:allstarprints2019@gmail.com" className="hover:text-white transition-colors">allstarprints2019@gmail.com</a>
            </li>
            <li className="flex items-start gap-2.5 text-sm text-brand-silver">
              <MapPin size={14} className="text-brand-red mt-0.5 flex-shrink-0" />
              <span>Dallas–Fort Worth, TX<br />By Appointment Only</span>
            </li>
            <li className="flex items-start gap-2.5 text-sm text-brand-silver">
